...
public class Add_Accountant extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            ...
            int contactno=Integer.parseInt(jTextField3.getText());
            Connection con=DriverManager.getConnection("jdbc:mariadb://localhost:3306/bg","root","root");
            Statement st=con.createStatement();
            int s=st.executeUpdate("insert into accountant(id,username,password,email,contactno) values("+id+",'"+username+"','"+password+"','"+email+"',"+contactno+");");
            JOptionPane.showMessageDialog(null, "Accountant record update");
